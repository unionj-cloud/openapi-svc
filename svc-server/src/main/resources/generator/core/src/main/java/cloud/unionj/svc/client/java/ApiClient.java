...
import cloud.unionj.svc.client.java.auth.ApiKeyAuth;
import cloud.unionj.svc.client.java.auth.HttpBasicAuth;
...
public class ApiClient {
  ...
  public void createDefaultAdapter() {
    ...
    String baseUrl = "http://gateway.c92358f369e164c2bbbdee14238b6e9a6.cn-beijing.alicontainer.com/community-server";
    if (!baseUrl.endsWith("/"))
      baseUrl = baseUrl + "/";
